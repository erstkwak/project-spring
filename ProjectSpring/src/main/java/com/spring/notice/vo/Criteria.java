...
/*
 * 현재 페이지의 데이터를 가져오기 위한 정보
 * - 페이지, 한 페이지의 표시할 데이터의 갯수, 시작 줄 번호, 끝 줄 번호
 * 
 * 화면에 보여줄 페이지 번호
 * - 한 페이지에 표시할 페이지 번호의 갯수, 시작페이지, 끝페이지, 전체 페이지 수
 * 	  이전 페이지 유무, 다음 페이지의 유무, 총 데이터의 갯수
 */
public class Criteria {
	...
	get 메서드 = Mapper가 사용할 get메서드를 정의
	*/
	/*
		startRow endRow = db ROWNUM 에서 나온 순서 시작 끝
	*/
		...
		// 맨처음 시작할 때  list 페이지는 1. 한 페이지에 표시할 데이터의 갯수는 10으로 정한다.
		...
		public void calc(Integer totalCount) {
